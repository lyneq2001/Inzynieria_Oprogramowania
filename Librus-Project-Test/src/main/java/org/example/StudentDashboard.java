...
public class StudentDashboard extends JFrame {
	...
	private void initializeComponents() {
		...
		JButton profileButton = new JButton("Profil"); // New button for profile management
		...
		profileButton.addActionListener(e -> new StudentProfile(username)); // Open profile screen
	}
